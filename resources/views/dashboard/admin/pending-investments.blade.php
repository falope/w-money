...
@section('title', 'Pending Investments | Wmoney.ng ')
...
@section('main-content')
                    ...
                    <div class="table-responsive">
                        <table style="width: 100%;" class="table table-hover table-striped table-bordered">
                            ...
                            <tbody>
                                @if (count($investments) > 0)
                                    @foreach ($investments as $count => $investment)
                                        <tr>
                                            ...
                                            <td> N/A </td>
                                            <td> Pending </td>
                                            <td><button class='btn btn-success activate-investment'
                                ...
                                @else
                                    <tr>
                                        <td colspan="13"> No available investment to show </td>
                                    </tr>
                                @endif
                            </tbody>
                        </table>
    ...
    <form id="activate-investment-form" method="post" action="{{ route('activate-investment') }}">
...
@section('script')
    <script type="text/javascript">
        $(document).ready(function() {
            $('.activate-investment').on('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $('#activate-investment-form').submit();
                    }
                })
            })
        })

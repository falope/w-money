...
@section('title', 'Manage Partnerships | Wmoney.ng ')
    ...
    <div class="headerpb-8 pt-5 pt-md-8"
        ...
        <div class="container-fluid">
            <div class="header-body" style="padding-bottom: 20px">
                <a href="{{ route('add-plan') }}" class="btn btn-success" style="margin-bottom: 30px; margin-top: -25px">
                    Add a new plan</a>
            </div>
        </div>
    </div>
    <div class="container-fluid mt--7" style="margin-top: -75px !important;">
        <div class="row mt-5">
            @if (count($plans) > 0)
                @foreach ($plans as $plan)
                    <div class="col-md-4 mb-4">
                        <div class="card shadow" style="padding:20px; min-height: 435px">
                            <div class="card-header border-0" style="padding: 0">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-12">
                                        <h3><b>{{ $plan->name }} (₦<?php echo number_format($plan->amount,
                                                2); ?>)</b></h3>
                            ...
                            <a href="{{ route('edit-plan', ['plan_id' => $plan->id]) }}" class="btn btn-success btn-block"
                                style="margin-top:10px; color:white">Edit Plan</a>
                        </div>
                    </div>
                @endforeach
            @endif
